    ...
    return (
        <>
            ...
            {isOpen && (
                ...
                >
                    <div
                        className={overlayClassName ? [styles[overlayClassName]] : styles.overlay}
                        onClick={handleOverlay}
                    />
                    <div
                        className={`${
                            classNameModalInner ? [styles[classNameModalInner]] : styles.modalInner
                        } ${isVisible ? styles.visible : styles.hidden}`}
                    >
                        <button className={styles.modalCloseBtn} onClick={handleClose}>
                            <img src={iconCloseBtn} alt="" />
                        </button>
                        {children || <ModalDefault onClose={handleClose} onConfirm={handleConfirm} />}
                    </div>
                </div>
            )}
        </>
